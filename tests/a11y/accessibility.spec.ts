...
test.describe('Accessibility Smoke Tests', () => {
  ...
  test('review page has flip button and rating buttons', async ({ page }) => {
    // Import a sample file first to ensure we have cards
    const samplePath = resolve(__dirname, '../../sample notes/04-eternal-soul.md')
