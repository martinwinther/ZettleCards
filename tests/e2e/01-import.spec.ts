...
test.describe('Import Flow', () => {
  ...
  test('should import markdown files and show them in library', async ({ page }) => {
    ...
    const sampleFiles = [
      resolve(__dirname, '../../sample notes/04-eternal-soul.md'),
      resolve(__dirname, '../../sample notes/05-what-is-bhakti.md')
    ]
  ...
  test('should handle duplicate detection', async ({ page }) => {
    ...
    const sampleFile = resolve(__dirname, '../../sample notes/04-eternal-soul.md')
    ...
    await expect(page.locator('text=duplicate(s) detected')).toBeVisible()
